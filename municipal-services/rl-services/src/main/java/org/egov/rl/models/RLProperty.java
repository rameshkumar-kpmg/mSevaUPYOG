...
//	private boolean isOldDataEncryptionRequest = false;
	...
	@Builder
	public RLProperty(String id, String propertyId, String surveyId, List<String> linkedProperties, String tenantId,
			String accountId, String oldPropertyId,
//			Status status,
//			Address address, 
//			String acknowldgementNumber,
			String propertyType, String ownershipCategory, List<OwnerInfo> owners,
...
//			List<Unit> units,
			JsonNode additionalDetails, AuditDetails auditDetails
...
//		this.workflow = workflow;
	...
	public RLProperty addOwnersItem(OwnerInfo ownersItem) {
		if (this.owners == null) {
...
//	public RLProperty addUnitsItem(Unit unit) {
//		if (this.units == null) {
...
//	public RLProperty addDocumentsItem(Document documentsItem) {
