...
import org.egov.rl.repository.builder.FuzzySearchQueryBuilder;
import org.egov.rl.web.contracts.FuzzySearchCriteria;
...
public class ElasticSearchRepository {
    ...
    @Autowired
    public ElasticSearchRepository(RentLeaseConfiguration config, FuzzySearchQueryBuilder queryBuilder, RestTemplate restTemplate, ObjectMapper mapper) {
        this.config = config;
     ...
     * @return
     */
    public Object fuzzySearchProperties(AllotmentCriteria criteria, List<String> uuids) {
